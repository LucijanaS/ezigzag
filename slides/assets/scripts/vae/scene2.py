...
class Scene2(VoiceoverScene):
    def construct(self):
        ...
        img_ref = (
            ImageMobject("../images/ref_3s.jpg")
        ...
        rand_img1 = (
            ImageMobject("../images/ref_4s.jpg")
            .set_resampling_algorithm(RESAMPLING_ALGORITHMS["none"])
            .scale(8)
        ...
        rand_img2 = (
            ImageMobject("../images/ref_5s.jpg")
            .set_resampling_algorithm(RESAMPLING_ALGORITHMS["none"])
            .scale(8)
            .next_to(VGroup(decoder, decoder_txt), RIGHT, buff=1.5)
        )
        ...
        rand_img3 = (
            ImageMobject("../images/ref_6s.jpg")
            .set_resampling_algorithm(RESAMPLING_ALGORITHMS["none"])
            .scale(8)
            .next_to(VGroup(decoder, decoder_txt), RIGHT, buff=1.5)
        )
        ...
        rand_img4 = (
            ImageMobject("../images/ref_7s.jpg")
            .set_resampling_algorithm(RESAMPLING_ALGORITHMS["none"])
            .scale(8)
            .next_to(VGroup(decoder, decoder_txt), RIGHT, buff=1.5)
        )
        ...
        solution_txt = Text("Regularize the latent space !", color=WHITE).scale(1.2)
